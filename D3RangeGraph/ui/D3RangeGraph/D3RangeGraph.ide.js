TW.IDE.Widgets.D3RangeGraph = function () {
	...
	/**
	 * Invoked by the runtime to obtain the link to this widget's sidebar icon.
	 */
	this.widgetIconUrl = function () {
		return  "../Common/extensions/D3RangeGraph/ui/D3RangeGraph/ComposerIcon@2x.png";
	}
	
    this.widgetProperties = function () {
        return {
            'name': 'D3 Range Chart',
            'description': 'D3 Range Chart',
            'category': ['Common'],
